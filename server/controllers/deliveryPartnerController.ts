...
export const completeDelivery = async (req: Request, res: Response) => {
    ...
    const updatededOrder = await prisma.order.update({
        where: {id: order.id},
        data: {status: "Delivered", statusHistory: history, deliveryOtp: ""}
    })

    res.json({order: updatededOrder, message: "Delivery completed successfully"})
}
...
export const cancelDelivery = async (req: Request, res: Response) => {
    ...
    res.json({order: updatededOrder, message: "Delivery cancelled"})
}
...
export const updateDeliveryStatus = async (req: Request, res: Response) => {
    ...
    return res.json({order: updatededOrder})
}
