                ...
                <label className="text-sm flex flex-col gap-1">
                    ...
                    <label className="text-sm flex flex-col gap-1">
                        ...
                        <div className="relative">
                            ...
                            required
                            placeholder="........"
                            className="custom-password-dots w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border not-focus:border-app-border transition-all"/>
                        </div>
                    </label>
                <button type="submit" disabled={loading} className="flex-center w-full py-3 bg-green-950 text-white font-semibold rounded-xl hover:bg-green-900
