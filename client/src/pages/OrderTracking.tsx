              ...
              <div className="bg-white rounded-2xl p-5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-app-text-light capitalize">Delivery Partner</p>
                  </div>
                </div>

                <a href={'tel:${order.deliverPartner.phone}'}  className="p-2.5 bg-app-cream rounded-xl hover:bg-app-cream-dark transition-colors">
                ...
                {order?.items.map((item, i) => (
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-app-text-light">x{item.quantity}</p>
                    </div>
